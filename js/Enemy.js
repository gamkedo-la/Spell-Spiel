...
bat.imgNumber = 2;
bat.cycleImage = true;
bat.introSound = "bat_intro";
bat.deathSound = "bat_death";
...
jellyfish.introSound = "seaJelly_intro";
jellyfish.deathSound = "seaJelly_death";
...
eyeMonster.introSound = "eye_intro";
eyeMonster.deathSound = "eye_death";
...
ghostChicken.introSound = "ghostChicken_intro";
ghostChicken.deathSound = "ghostChicken_death";
...
zombie.introSound = "zombie_intro";
zombie.deathSound = "zombie_death";
zombie.weakAttacks = [];
...
lizard.introSound = "lizard_intro";
lizard.deathSound = "lizard_death";
lizard.weakAttacks = [];
